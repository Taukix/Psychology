 ...
 */
final class Version20230930183912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD first_name VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE users ADD last_name VARCHAR(50) NOT NULL');
